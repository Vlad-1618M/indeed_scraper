#!/bin/bash
# =============================================================================
# Indeed Camoufox Scraper - Installation Script
...
# ___ Install Python deps
echo ""
echo "[1/4] Installing Python dependencies..."
pip install --upgrade pip
pip install --upgrade certifi
# ___ pip install -U "camoufox[geoip]"
pip install "camoufox==0.4.10"
pip install playwright

# ___ get SSL certs | required for macOS:
echo ""
...
# ___ Download Camoufox browser
echo ""
echo "[3/4] Downloading Camoufox browser..."
camoufox fetch

# ___  installation check:
echo ""
